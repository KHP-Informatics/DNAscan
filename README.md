...
[Alfredo Iacoangeli et al. DNAscan: a fast, computationally and memory efficient bioinformatics pipeline for analysis of DNA next-generation-sequencing data. biorXiv, 2018](https://alfredokcl.github.io/sample_report/dnascan_manuscript.pdf)
