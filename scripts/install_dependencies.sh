...
echo "###########################################IMPORTANT######################################################"
echo "Hisat2-build and bwa-index are still creating their indexes and Annovar is still downloading the CADD database (wget). Please wait untill they complete their task."
