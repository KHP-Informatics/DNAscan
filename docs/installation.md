...
=================
   ...
   * [Installation](#installation)
      ...
      * [Dependencies](#dependencies)
         * [List of Software dependencies](#list-of-software-dependencies)
         * [How to install dependencies using Bioconda](#how-to-install-dependencies-using-bioconda)
         * [iobio services](#iobio-services)
      ...
      * [Docker/Singularity](#dockersingularity)
               ...
               * [Singularity setup](#singularity-setup)
                  * [Linux](#linux)
                  * [MAC](#mac-1)
      * [Getting DNAscan](#getting-dnascan)
...
A guide to getting, installing and setting up DNAscan
...
- Space required by the installation: 
  - We recommend at least 10Gb of free space for the whole DNAscan deployment, including the all dependencies. 
  - 8Gb for the reference human genome and the hisat2 index. 
  - An extra 5.5Gb for the bwa index are required if you want to use the normal or intensive modes   
...
### How to install dependencies using Bioconda
